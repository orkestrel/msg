...
| ------- | -------------------------- | ------------------------- | ------------------------------------- |
| MSG     | [`src/msg.md`](src/msg.md) | [`src/core`](../src/core) | [`tests/src/core`](../tests/src/core) |

## By directory

| Directory  | Guide                      |
| ---------- | -------------------------- |
| `src/core` | [`src/msg.md`](src/msg.md) |

## Dependency reference

`@orkestrel/msg` is a **core-only** package with zero `@orkestrel/*` runtime
